...
public interface PointsMallOrderService extends IService<PointsMallOrder> {
    ...
    void onlyRefundByAdmin(PointsMallOrderParam param);
    ...
    Map selectRefundInfo(PointsMallOrderParam param);
     ...
     * @return
     */
    XSSFWorkbook createExcel(List<PointsMallOrderResult> list);
}