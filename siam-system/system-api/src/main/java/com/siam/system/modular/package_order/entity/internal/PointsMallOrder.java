...
public class PointsMallOrder {
    ...
    private Date deliveryLastUpdateTime;
    ...
    private String firstGoodsMainImage;

    private Integer goodsSource;

    private String goodsSourceOrderNo;
    ...
    public Date getDeliveryLastUpdateTime() {
        return deliveryLastUpdateTime;
    }

    public void setDeliveryLastUpdateTime(Date deliveryLastUpdateTime) {
        this.deliveryLastUpdateTime = deliveryLastUpdateTime;
    }
    ...
    public String getFirstGoodsMainImage() {
        return firstGoodsMainImage;
    }

    public void setFirstGoodsMainImage(String firstGoodsMainImage) {
        this.firstGoodsMainImage = firstGoodsMainImage == null ? null : firstGoodsMainImage.trim();
    }
    ...
    public String getGoodsSourceOrderNo() {
        return goodsSourceOrderNo;
    }

    public void setGoodsSourceOrderNo(String goodsSourceOrderNo) {
        this.goodsSourceOrderNo = goodsSourceOrderNo == null ? null : goodsSourceOrderNo.trim();
    }
