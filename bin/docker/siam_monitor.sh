###构建docker镜像
cd /root/project/siam-mall/siam-monitor/
...
docker tag siam-monitor:v1.0 registry-vpc.cn-hangzhou.aliyuncs.com/siam-mall/siam-monitor:v1.0

docker push registry-vpc.cn-hangzhou.aliyuncs.com/siam-mall/siam-monitor:v1.0
