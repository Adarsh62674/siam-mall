<template>
	<view class="container">
		...
		<view class="userinfo" :style="'margin-top:' + (statusBarHeight + 30) + 'rpx;'">
			...
			<block v-else>
				<navigator url="/subPackages_pages/mine/userinfo/userinfo" class="navigator-userinfo">
			...
			<view id="content_info" v-if="data.id">
				<view class="mine-blocking-view">
					<view class="mine-blocking">
						<navigator class="mine-navigator" url="/subPackages_pages/mine/share/reward/reward">
							<view class="number-tip theme-color">{{ data.inviteRewardAmount }}</view>
							<view class="text-tip">佣金</view>
						</navigator>
						<text class="line-tip">|</text>
						<navigator class="mine-navigator" url="/subPackages_pages/mine/integral/integral">
							<view class="number-tip theme-color">{{ data.points }}</view>
							<view class="text-tip">我的积分</view>
						</navigator>
						<text class="line-tip">|</text>
						<navigator class="mine-navigator" url="/subPackages_pages/mine/coupons/coupons">
							<view class="number-tip theme-color">{{ data.couponsNumber ? data.couponsNumber : 0 }}
							</view>
							<view class="text-tip">优惠券</view>
						</navigator>
						<text class="line-tip">|</text>
						<navigator class="mine-navigator" url="/subPackages_pages/mine/member/index/index">
				...
				<view class="my-order-box">
						...
						<swiper-item class="swiper-items">
							<view class="mine-blocking">
								<navigator class="order-navigator"
									:url="'/subPackages_pages/order/index/index?currentTab=' + currentTab + '&modeType=' + item.modeType + '&currentOrderTab=' + item.modeId"
					...
					<navigator class="navigator-class" url="/subPackages_pages/mine/collect/index/index">
				...
				<view class="navigator-box">
					<view class="navigator-radius">
						<navigator class="navigator-class" url="/subPackages_pages/address/index/index">
							<view class="navigator-view">
								<view>收货地址</view>
								<van-icon name="arrow" />
							</view>
						...
						<navigator class="navigator-class" url="/subPackages_pages/mine/security/index/index">
							<view class="navigator-view">
								<view>账号安全</view>
								<van-icon name="arrow" />
							</view>
						...
						<!-- 分享 -->
						<view class="view-line"></view>
						<navigator class="navigator-class" :url="'/subPackages_pages/mine/share/index/index?inviterId=' + data.id">
	...
	export default {
		...
		methods: {
			...
			getUserProfile(e) {
				...
				// #ifdef APP-PLUS||H5
				uni.navigateTo({
					url: '/subPackages_pages/internal/login/code/code'
				});
				// #endif
				// #ifdef MP-WEIXIN||MP-ALIPAY
				uni.navigateTo({
					url: '/subPackages_pages/internal/login/choose/choose'
				});
				// #endif
			},
			...
			bindUserinfoTap() {
				uni.navigateTo({
					url: '/subPackages_pages/mine/userinfo/userinfo'
				});
			},
			...
			bindAccountBalance() {
				uni.navigateTo({
					url: '/subPackages_pages/mine/balance/index/index'
				});
			},

			bindMemberCenter() {
				uni.navigateTo({
					url: '/subPackages_pages/mine/member/index/index'
				});
			},
			...
			bindOrderInfo(e) {
				uni.navigateTo({
					url: '/subPackages_pages/order/index/index?currentTab=0&modeType=all&currentOrderTab=0'
				});
			}
		}
	};
