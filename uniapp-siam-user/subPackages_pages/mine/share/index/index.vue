<template>
	<view class="share-top">
		...
		<van-action-sheet :show="createGoodImgDialog" title="朋友圈分享美图" @close="close" @cancel="close">
			<view class="content_box">
		...
		<van-dialog title="保存图片" :show="saveDialogShow" :buttons="buttons" :mask-closable="maskClosable" @close="close" @cancel="close"
	...
	export default {
		...
		onShareAppMessage: function(options) {
			...
			var shareObj = {
				...
				path: '/subPackages_pages/internal/login/choose/choose?inviterId=' + inviterId,
			...
			saveImageToPhotosAlbum: function() {
				...
				uni.getImageInfo({
					...
					success(res) {
						...
						ctx.fillText('', 10, res.height / 3 + 40);
						ctx.fillText('', 10, res.height / 3 + 60);
						ctx.fillText('', 10, res.height / 3 + 80);
						ctx.setFontSize(13);
