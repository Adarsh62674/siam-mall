	...
	export default {
		...
		methods: {
			...
			getOrderList(tabType, keyWords) {
				...
				var tableId = diningTable.tableId;
				orderJs.memberOrderList(pageNo, pageSize, tabType, keyWords, tableId).then((result) => {
					if (result.success) {
			...
			onReachBottom() {
				...
				var diningTable = deliveryAndSelfTaking.diningTable;
				var tableId = diningTable.tableId;
				var tabType = this.pointsOrderTabList[this.currentOrderTab].modeType;
