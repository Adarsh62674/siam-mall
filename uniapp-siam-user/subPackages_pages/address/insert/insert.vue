			...
			<view class="address-info-list">
				...
				<view class="address-info-item">
					...
					<view class="section" @tap="getRegeoAddress">
						<input placeholder="选择收货地址" disabled="disabled" name="street" :value="street" style="pointer-events:none;"/>
						<van-icon name="arrow" />
					</view>
				</view>
				<view class="address-info-item">
	...
	export default {
		...
		methods: {
			...
			tagRadioChange(e) {
				...
				this.tagKey= checkedValue;
					this.tagRadio= this.tagRadio;
			},
